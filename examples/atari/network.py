...
def network_maker(obs_spec: Any, action_spec: Any, use_orthogonal: bool) -> Any:
  """Atari network maker."""
  ...
  torso_net_maker = partial(DenseTorso, "torso", [512])
  policy_net_maker = partial(DiscreteAction, "action", action_spec.num_values)
  value_net_maker = partial(DenseValue, "value", [512, 32])
  return CommonNet(
